...
int main(void)
{
   ...
   RUN_TEST(test_reduce_positive_rational_number_to_lowest_terms); RUN_TEST(test_reduce_places_minus_sign_on_numerator); RUN_TEST(test_reduce_negative_rational_number_to_lowest_terms); RUN_TEST( test_reduce_rational_number_with_negative_denominator_to_lowest_terms); RUN_TEST(test_reduce_zero_to_lowest_terms); RUN_TEST(test_reduce_integer_to_lowest_terms); RUN_TEST(test_reduce_one_to_lowest_terms); return UNITY_END(); }